...
function assets.load()
	...
	assets[ ASSET_TYPE.ENEMY_SHIP ] = lovr.graphics.newModel( "devres/enemy_ship.glb" )
	assets[ ASSET_TYPE.ENEMY_LASER_BEAM ] = lovr.graphics.newModel( "devres/enemy_laser_beam.glb" )
	assets[ ASSET_TYPE.PADDLE_ESCAPE ] = lovr.graphics.newModel( "devres/paddle_escape.glb" )
	assets[ ASSET_TYPE.ENEMY_BALOONS ] = lovr.graphics.newModel( "devres/enemy_baloons.glb" )
	assets[ ASSET_TYPE.ENEMY_CONE ] = lovr.graphics.newModel( "devres/enemy_cone.glb" )
	assets[ ASSET_TYPE.ENEMY_PYRAMID ] = lovr.graphics.newModel( "devres/enemy_pyramid.glb" )
	...
	assets[ ASSET_TYPE.SHADER_PBR ] = lovr.graphics.newShader( "devres/shader_PBR.vs", "devres/shader_PBR.fs",
